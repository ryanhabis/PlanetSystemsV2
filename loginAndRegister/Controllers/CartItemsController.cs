...
namespace starSystemV2.Controllers
{
    public class CartItemsController : Controller
    {
        ...
        public CartItemsController(PlanetsContext context)
        {
            _context = context;
        }
        ...
        {
            var planetsContext = _context.CartItem.Include(c => c.Product).Include(c => c.ShoppingCart);
            return View(await planetsContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("CartItemId,ProductId,Quantity,ShoppingCartId")] CartItem cartItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CartItemId,ProductId,Quantity,ShoppingCartId")] CartItem cartItem)
        {
