...
namespace starSystemV2.Controllers
{
    public class ProductsController : Controller
    {
        private readonly PlanetsContext _context;

        public ProductsController(PlanetsContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ProductId,Name,Price,Description,ImageUrl")] Product product)
        {
