...
namespace starSystemV2.Controllers
{
    public class ShoppingCartsController : Controller
    {
        ...
        public ShoppingCartsController(PlanetsContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ShoppingCartId,UserId")] ShoppingCart shoppingCart)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ShoppingCartId,UserId")] ShoppingCart shoppingCart)
        {
